 ...
 */
public class NoManHuaFragment extends BaseFragment implements UpdatePointsListener {

    private View view;
    @BindView(R.id.jifenCount)
    TextView jifenCount;

    private final static int OPEN_7 = 60;
    private final static int OPEN_30 = 110;

    private String displayPointsText;

    final Handler mHandler = new Handler();

    public NoManHuaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_manhua_no, container, false);
    ...
    public void open7(){
        if(displayPointsText != null && !"".equals(displayPointsText)
            ...
            editor.putString("date_manhua", toDate);
            editor.commit();
